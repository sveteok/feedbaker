...
export function SvgPromo() {
  return (
    <svg
      className="xtext-shadow-xl xtext-shadow-white "
...
export function SvgSecure() {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="icon icon-tabler icons-tabler-outline icon-tabler-shield-star"
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
